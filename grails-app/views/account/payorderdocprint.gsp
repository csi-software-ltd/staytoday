<html>
  <head>
    ...
    <style type="text/css">
      @font-face {
        src: url('${resource(dir:'fonts',file:'arial.ttf',absolute:true)}');
        -fs-pdf-font-embed: embed;
        -fs-pdf-font-encoding: cp1251;
      }
  <g:if test="${payorder.payway_id==1}">
      body { width: 210mm; margin-left: auto; margin-right: auto; /*border: 1px #efefef solid;*/ font-size: 10px; font-family: Arial }
...
<g:if test="${payorder.payway_id==1}">
    ...
    <br/>
    <div style="background-color:#000; width:600px; font-size:1px; height:2px;">&nbsp;</div>
    ...
    <div style="position:relative">
      ...
      <div style="position:absolute;width:75px;height:40px;top:-20px;left:120px"><img height="35" src="${resource(dir:'images',file:'signature1.png')}" /></div>
    </div>
    <br/>
    <div style="position:relative">
      <div>Главный бухгалтер ______________________ (${client.accountant})</div>
      <div style="position:absolute;width:75px;height:40px;top:-10px;left:110px"><img height="25" src="${resource(dir:'images',file:'signature2.png')}" /></div>
    </div>
    <br/>
    <div style="position:relative">
      <div style="width: 85mm;text-align:center;">М.П.</div>
      <div style="position:absolute;width:135px;height:135px;top:-60px;left:90px"><img height="135" src="${resource(dir:'images',file:'stamp.png')}" /></div>
    </div>
    <br/>
      ...
      <tr>
        ...
        <td valign="top">
          ...
          <li>
            ...
            <b>00</b> коп. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;<br /><br />
            Подпись:________________________ Дата: &quot;__&quot;&nbsp;_______&nbsp;&nbsp;${new Date().getYear()+1900} г.<br /><br />
          </li>
        </td>
      </tr>
      <tr>
