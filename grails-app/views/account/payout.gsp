                        ...
                        <table class="form" width="100%" cellpadding="5" cellspacing="0" border="0">
                          ...
                          <tr>
                            <td id="reserveschemetd" style="padding:20px 7px 0">
                              ...
                              <select name="reserve_id" id="reserve_id" style="width:200px" onchange="this.options[this.selectedIndex].onfocus()">
                              <g:each in="${reserve}" var="item">
                                <option value="${item.id}" onfocus="enableSubmitButton();displaypayaccount(this.value);$('paydesc').update('${item['description'+context?.lang]}')" <g:if test="${item.id==client?.reserve_id}">selected="selected"</g:if>>${item['name'+context?.lang]}</option>
                              </g:each>
                              </select>
                            </td>
